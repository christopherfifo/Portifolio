...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  const title =
    language === "EN" && project.tituloEn ? project.tituloEn : project.titulo;
  const description =
    language === "EN" && project.descricaoEn
      ? project.descricaoEn
      : project.descricao;
    ...
    >
      ...
      <div className="p-6 sm:p-8 flex flex-col flex-grow relative">
        ...
        <div className="relative mb-8">
          <p
            className={`text-zinc-400 text-sm sm:text-base leading-relaxed transition-all duration-300 ${!isExpanded ? "line-clamp-3 sm:line-clamp-none" : ""}`}
          >
            {description}
          </p>
